...
//        }.start();
    ...
    private String saveCrashInfoToFile(Throwable ex) {
        ...
        try {
            ...
            if (isExistExternalStore()) {
                File dir = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/sthomecrash");
                if (!dir.exists()) {
                    dir.mkdirs();
                }
            ...
            Log.i(TAG, "an error occured while writing report file..." + e.getMessage());
        }
        return null;
    }
    ...
    public void collectCrashDeviceInfo(Context ctx) {
        try {
            ...
            Log.e(TAG,"ds");
            //.e(TAG, "Error while collect package info" + e.getMessage());
        }
