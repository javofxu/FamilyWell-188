    ...
    private static void initAppInfo(String json) {
        try {
            if (!TextUtils.isEmpty(json)) {
                ...
                CacheUtil.putString(SETTINGS_CONFIG_ENCODE,jsonConfig.getString("encode"));
                CacheUtil.putString(SETTINGS_CONFIG_UPDATE_AUTO,jsonConfig.getString("update_auto"));
            } else {
