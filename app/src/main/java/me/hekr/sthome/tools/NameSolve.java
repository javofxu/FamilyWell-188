...
public class NameSolve {
    ...
    public static String getEqType(String Eqipmentdesc){
        ...
        }else if ("020E".equals(Eqipmentdesc) || "120E".equals(Eqipmentdesc) || "220E".equals(Eqipmentdesc)) {
            return OUTDOOR_SIREN;
        }else if ("0401".equals(Eqipmentdesc) || "1401".equals(Eqipmentdesc) || "2401".equals(Eqipmentdesc)) {
            return DATA_SWITCH;
        }
        return "";
    }
    ...
    public static String getDefaultName(Context context, String devType, String eqid){
        ...
        try {
            ...
            }else if ("020E".equals(devType) || "120E".equals(devType) || "220E".equals(devType)) {
                return context.getResources().getString(R.string.outdoor_siren) + eqid;
            }else if ("0401".equals(devType) || "1401".equals(devType) || "2401".equals(devType)) {
                return context.getResources().getString(R.string.data_switch) + eqid;
            }
        }catch (Exception e){
            return "";
        }
