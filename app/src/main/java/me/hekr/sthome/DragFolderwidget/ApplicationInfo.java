...
public class ApplicationInfo extends ItemInfo {
    ...
    public void measureTitle(Paint paint, LayoutCalculator lc) {
        ...
        if (TextUtils.isEmpty(text)) {
            ...
            }else if (NameSolve.OUTDOOR_SIREN.equals(NameSolve.getEqType(equipmentDesc))) {  //end
                text = MyApplication.getAppResources().getString(R.string.outdoor_siren) + eqid;
            }else if (NameSolve.DATA_SWITCH.equals(NameSolve.getEqType(equipmentDesc))) {  //end
                text = MyApplication.getAppResources().getString(R.string.data_switch) + eqid;
            }
