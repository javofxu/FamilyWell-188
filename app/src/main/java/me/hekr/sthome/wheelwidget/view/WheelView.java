...
public class WheelView extends View {
     ...
     */
    private static final int VALUE_TEXT_COLOR = 0xfff56735;

    /**
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0xffc8c8c8;
     ...
     */
    private final int ITEM_OFFSET = 18 / 5;
    ...
    public boolean colorfulflag = false;
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize(getResources().getDimensionPixelSize(R.dimen.wheel_font_size));
            itemsPaint.setColor(0xFF666666);
        }

        if (valuePaint == null) {
            valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG | Paint.DITHER_FLAG);
            valuePaint.setTextSize(getResources().getDimensionPixelSize(R.dimen.wheel_font_size));
        }
    ...
    private void drawValue(Canvas canvas) {
        ...
        if(!colorfulflag){
            ...
            switch (currentItem){
                case 0:
                    valuePaint.setColor(getResources().getColor(R.color.gateway_color_0));
                    break;
                case 1:
                    valuePaint.setColor(getResources().getColor(R.color.gateway_color_1));
                    break;
                case 2:
                    valuePaint.setColor(getResources().getColor(R.color.gateway_color_2));
                    break;
                case 3:
                    valuePaint.setColor(getResources().getColor(R.color.gateway_color_3));
                    break;
                case 4:
                    valuePaint.setColor(getResources().getColor(R.color.gateway_color_4));
                    break;
                case 5:
                    valuePaint.setColor(getResources().getColor(R.color.gateway_color_5));
                    break;
                case 6:
                    valuePaint.setColor(getResources().getColor(R.color.gateway_color_6));
                    break;
                case 7:
                    valuePaint.setColor(getResources().getColor(R.color.gateway_color_7));
                    break;
                case 8:
