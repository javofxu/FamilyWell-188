...
public class TempControlDetailActivity extends AppCompatActivity implements OnClickListener{
    ...
    private RadioButton window_check_1,valve_check_1;
    ...
    private void initViewGuider() {
        window_check_1 = (RadioButton)findViewById(R.id.window_check);
        valve_check_1 = (RadioButton)findViewById(R.id.valve_check);
    ...
    private void doStatusShow(String aaaa) {
        try {
           ...
           if(shineng_window2!=0) {
               ...
               window_check_1.setText(getResources().getString(R.string.window_status));
           }else {
               window_status.setText(getResources().getString(R.string.disable));
               window_check_1.setText(getResources().getString(R.string.window_check));
           }
            if(shineng_valve2!=0) {
                ...
                valve_check_1.setText(getResources().getString(R.string.valve_status));
            }else{
                valve_status.setText(getResources().getString(R.string.disable));
                valve_check_1.setText(getResources().getString(R.string.valve_check));
            }
