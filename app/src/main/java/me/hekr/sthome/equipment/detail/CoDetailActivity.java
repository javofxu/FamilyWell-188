...
//                Toast.makeText(CoDetailActivity.this,"operation success",Toast.LENGTH_LONG).show();
    ...
    private void initViewGuider() {
        ...
        edt_txt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ECListDialog ecListDialog = new ECListDialog(CoDetailActivity.this,getResources().getStringArray(R.array.DeivceOperation));
                    ...
                    public void onDialogItemClick(Dialog d, int position) {
                        ...
                        switch (position){
                            case 0:
                                ...
                                Intent intent =new Intent(CoDetailActivity.this,AddDeviceActivity.class);
                                ...
                                break;
                            case 1:
                                ECAlertDialog elc = ECAlertDialog.buildAlert(CoDetailActivity.this,getResources().getString(R.string.delete_or_not), getResources().getString(R.string.cancel), getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                                    @Override
                                ...
                                break;
                            case 2:
                                alertDialog = ECAlertDialog.buildAlert(CoDetailActivity.this, getResources().getString(R.string.update_name),getResources().getString(R.string.cancel),getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if(!TextUtils.isEmpty(newname)){
                                            ...
                                            try {
                                                ...
                                                if(newname.getBytes(encode).length<=15){
                                                    if(!EmojiFilter.containsEmoji(newname)) {
                                                        ...
                                                        Toast.makeText(CoDetailActivity.this,getResources().getString(R.string.name_contain_emoji),Toast.LENGTH_SHORT).show();
                                                    }
                                                }else{
                                                    alertDialog.setDismissFalse(false);
                                                    Toast.makeText(CoDetailActivity.this,getResources().getString(R.string.name_is_too_long),Toast.LENGTH_SHORT).show();
                                                }
                                            ...
                                            alertDialog.setDismissFalse(false);
                                            Toast.makeText(CoDetailActivity.this,getResources().getString(R.string.name_is_null),Toast.LENGTH_SHORT).show();
                                        }
        ...
        if(TextUtils.isEmpty(device.getEquipmentName())){
            eq_name.setText(getResources().getString(R.string.coalarm)+device.getEqid());
        }else{
        ...
        deviceLogo.setImageResource(R.drawable.detail9);
    ...
    public  void onEventMainThread(STEvent event){
        if(event.getEvent() == SendCommand.MODIFY_EQUIPMENT_NAME){
            ...
            SendCommand.clearCommnad();
            Toast.makeText(CoDetailActivity.this,getResources().getString(R.string.delete_success),Toast.LENGTH_SHORT).show();
            ED = new EquipDAO(CoDetailActivity.this);
            ED.deleteByEqid(device);
            finish();
        }else if(event.getEvent()== SendCommand.EQUIPMENT_CONTROL){
            SendCommand.clearCommnad();
            Toast.makeText(CoDetailActivity.this,getResources().getString(R.string.success_test),Toast.LENGTH_SHORT).show();
        }
        ...
        HekrUserAction.getInstance(this).getAlarmHistoryList(this, ConnectionPojo.getInstance().deviceTid, ConnectionPojo.getInstance().ctrlKey, ConnectionPojo.getInstance().propubkey, page, new HekrUser.GetDeviceHistoryListener() {
            ...
            public void getFail(int errorCode) {
                ...
                if(errorCode==1){
                    ...
                    Toast.makeText(CoDetailActivity.this, UnitTools.errorCode2Msg(CoDetailActivity.this,errorCode),Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void openSelectSecond(){
        alertDialog2 = ECAlertDialog.buildAlert(CoDetailActivity.this, getResources().getString(R.string.please_choose),getResources().getString(R.string.cancel),getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
            }
        }, new DialogInterface.OnClickListener() {
