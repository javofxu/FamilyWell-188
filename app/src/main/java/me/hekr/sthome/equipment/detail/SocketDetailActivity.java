...
public class SocketDetailActivity extends AppCompatActivity {
    ...
    private static  final  String TAG = "SocketDetail";
    private EquipDAO ED;
...
//                Toast.makeText(SocketDetailActivity.this,"operartion Success",Toast.LENGTH_SHORT).show();
            ...
            protected void operationFailed() {
                Toast.makeText(SocketDetailActivity.this,getResources().getString(R.string.operation_failed),Toast.LENGTH_SHORT).show();
            }
        };
        try{
...
//                Toast.makeText(SocketDetailActivity.this,"operation success",Toast.LENGTH_LONG).show();
    ...
    private void initViewGuider() {
        ...
        edt_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ECListDialog ecListDialog = new ECListDialog(SocketDetailActivity.this,getResources().getStringArray(R.array.DeivceOperation));
                    ...
                    public void onDialogItemClick(Dialog d, int position) {
                        ...
                        switch (position){
                            case 0:
                                ...
                                Intent intent =new Intent(SocketDetailActivity.this,AddDeviceActivity.class);
                                ...
                                break;
                            case 1:
                                ECAlertDialog elc = ECAlertDialog.buildAlert(SocketDetailActivity.this,getResources().getString(R.string.delete_or_not), getResources().getString(R.string.cancel), getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                                    @Override
                                ...
                                break;
                            case 2:
                                alertDialog = ECAlertDialog.buildAlert(SocketDetailActivity.this, getResources().getString(R.string.update_name),getResources().getString(R.string.cancel),getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if(!TextUtils.isEmpty(newname)){
                                            ...
                                            try {
                                                ...
                                                if(newname.getBytes(encode).length<=15){
                                                    if(!EmojiFilter.containsEmoji(newname)) {
                                                        ...
                                                        Toast.makeText(SocketDetailActivity.this,getResources().getString(R.string.name_contain_emoji),Toast.LENGTH_SHORT).show();
                                                    }
                                                }else{
                                                    alertDialog.setDismissFalse(false);
                                                    Toast.makeText(SocketDetailActivity.this,getResources().getString(R.string.name_is_too_long),Toast.LENGTH_SHORT).show();
                                                }
                                            ...
                                            alertDialog.setDismissFalse(false);
                                            Toast.makeText(SocketDetailActivity.this,getResources().getString(R.string.name_is_null),Toast.LENGTH_SHORT).show();
                                        }
        ...
        if(TextUtils.isEmpty(device.getEquipmentName())){
            eq_name.setText(getResources().getString(R.string.socket)+device.getEqid());
        }else{
    ...
    private void chuli(){
        ...
        if(device.getState() == null || "".equals(device.getState()) || device.getState().length()!=8){
            sd.sendEquipmentCommand(eqid,"0101ffff");
        }else {
...
//                    holder.s.setText("断开");
    ...
    public  void onEventMainThread(STEvent event){
        if(event.getEvent() == SendCommand.MODIFY_EQUIPMENT_NAME){
            ...
            updateName(newname);
            Toast.makeText(SocketDetailActivity.this,getResources().getString(R.string.update_name_success),Toast.LENGTH_SHORT).show();
        }else if(event.getEvent() == SendCommand.DELETE_EQUIPMENT_DETAIL){
            SendCommand.clearCommnad();
            Toast.makeText(SocketDetailActivity.this,getResources().getString(R.string.delete_success),Toast.LENGTH_SHORT).show();
            ED = new EquipDAO(SocketDetailActivity.this);
