 ...
 */
public class ModeButtonDetailActivity extends AppCompatActivity implements ModeButtonAdapter.ChangeDesMode,MultiDirectionSlidingDrawer.OnDrawerOpenListener,MultiDirectionSlidingDrawer.OnDrawerCloseListener{
        ...
        HekrUserAction.getInstance(this).getAlarmHistoryList(this, ConnectionPojo.getInstance().deviceTid, ConnectionPojo.getInstance().ctrlKey, ConnectionPojo.getInstance().propubkey, page, new HekrUser.GetDeviceHistoryListener() {
            ...
            public void getFail(int errorCode) {
                ...
                if(errorCode==1){
                    ...
                    Toast.makeText(ModeButtonDetailActivity.this, UnitTools.errorCode2Msg(ModeButtonDetailActivity.this,errorCode),Toast.LENGTH_LONG).show();
                }
            }
        });
    }
