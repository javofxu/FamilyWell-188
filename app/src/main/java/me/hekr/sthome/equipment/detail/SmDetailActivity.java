 ...
 */
public class SmDetailActivity extends AppCompatActivity implements MultiDirectionSlidingDrawer.OnDrawerOpenListener,MultiDirectionSlidingDrawer.OnDrawerCloseListener{
    private static final String TAG = "SmDetail";
    ...
    private void initViewGuider() {
        ...
        edt_txt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ECListDialog ecListDialog = new ECListDialog(SmDetailActivity.this,getResources().getStringArray(R.array.DeivceOperation));
                    ...
                    public void onDialogItemClick(Dialog d, int position) {
                        ...
                        switch (position){
                            case 0:
                                ...
                                Intent intent =new Intent(SmDetailActivity.this,AddDeviceActivity.class);
                                ...
                                break;
                            case 1:
                                ECAlertDialog elc = ECAlertDialog.buildAlert(SmDetailActivity.this,getResources().getString(R.string.delete_or_not), getResources().getString(R.string.cancel), getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                                    @Override
                                ...
                                break;
                            case 2:
                                alertDialog = ECAlertDialog.buildAlert(SmDetailActivity.this, getResources().getString(R.string.update_name),getResources().getString(R.string.cancel),getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if(!TextUtils.isEmpty(newname)){
                                            ...
                                            try {
                                                ...
                                                if(newname.getBytes(encode).length<=15){
                                                    if(!EmojiFilter.containsEmoji(newname)) {
                                                        ...
                                                        Toast.makeText(SmDetailActivity.this,getResources().getString(R.string.name_contain_emoji),Toast.LENGTH_SHORT).show();
                                                    }
                                                }else{
                                                    alertDialog.setDismissFalse(false);
                                                    Toast.makeText(SmDetailActivity.this,getResources().getString(R.string.name_is_too_long),Toast.LENGTH_SHORT).show();
                                                }
                                            ...
                                            alertDialog.setDismissFalse(false);
                                            Toast.makeText(SmDetailActivity.this,getResources().getString(R.string.name_is_null),Toast.LENGTH_SHORT).show();
                                        }
        ...
        operation.setText(getResources().getString(R.string.test));
        ...
        if(TextUtils.isEmpty(device.getEquipmentName())){
            eq_name.setText(getResources().getString(R.string.smalarm)+device.getEqid());
        }else{
    ...
    private void updateName(String edit) {
        if( !device.getEquipmentName().equals(edit)){
            ...
            try {
                ...
                Toast.makeText(SmDetailActivity.this,getResources().getString(R.string.name_is_repeat),Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public  void onEventMainThread(STEvent event){
        if(event.getEvent() == SendCommand.MODIFY_EQUIPMENT_NAME){
            ...
            updateName(newname);
            Toast.makeText(SmDetailActivity.this,getResources().getString(R.string.update_name_success),Toast.LENGTH_SHORT).show();
        }else if(event.getEvent() == SendCommand.DELETE_EQUIPMENT_DETAIL){
            SendCommand.clearCommnad();
            Toast.makeText(SmDetailActivity.this,getResources().getString(R.string.delete_success),Toast.LENGTH_SHORT).show();
            ED = new EquipDAO(SmDetailActivity.this);
            ED.deleteByEqid(device);
            finish();
        }else if(event.getEvent()== SendCommand.EQUIPMENT_CONTROL){
            SendCommand.clearCommnad();
            Toast.makeText(SmDetailActivity.this,getResources().getString(R.string.success_test),Toast.LENGTH_SHORT).show();
        }
        ...
        HekrUserAction.getInstance(this).getAlarmHistoryList(this, ConnectionPojo.getInstance().deviceTid, ConnectionPojo.getInstance().ctrlKey, ConnectionPojo.getInstance().propubkey, page, new HekrUser.GetDeviceHistoryListener() {
            ...
            public void getFail(int errorCode) {
                ...
                if(errorCode==1){
                    ...
                    Toast.makeText(SmDetailActivity.this, UnitTools.errorCode2Msg(SmDetailActivity.this,errorCode),Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void openSelectSecond(){
        alertDialog2 = ECAlertDialog.buildAlert(SmDetailActivity.this, getResources().getString(R.string.please_choose),getResources().getString(R.string.cancel),getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
            }
        }, new DialogInterface.OnClickListener() {
