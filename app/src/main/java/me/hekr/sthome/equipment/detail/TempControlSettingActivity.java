...
public class TempControlSettingActivity extends TopbarSuperActivity {
    ...
    private void initdata(){
        ...
        String[] window_check2 = getResources().getStringArray(R.array.gs361_action);
        String[] tongsuo_check2 = getResources().getStringArray(R.array.gs361_action);
        String[] valve_check2 = getResources().getStringArray(R.array.gs361_action);
