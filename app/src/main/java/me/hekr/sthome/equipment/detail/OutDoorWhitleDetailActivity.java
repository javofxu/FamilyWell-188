 ...
 */
public class OutDoorWhitleDetailActivity extends AppCompatActivity implements MultiDirectionSlidingDrawer.OnDrawerOpenListener,MultiDirectionSlidingDrawer.OnDrawerCloseListener{
    private static final String TAG = "OutDoorWhitleDetailActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_outdoor_siren);
        initData();
        initViewGuider();
    }
...
//                Toast.makeText(CoDetailActivity.this,"operation success",Toast.LENGTH_LONG).show();
    ...
    private void initViewGuider() {
        ...
        edt_txt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ECListDialog ecListDialog = new ECListDialog(OutDoorWhitleDetailActivity.this,getResources().getStringArray(R.array.DeivceOperation));
                    ...
                    public void onDialogItemClick(Dialog d, int position) {
                        ...
                        switch (position){
                            case 0:
                                ...
                                Intent intent =new Intent(OutDoorWhitleDetailActivity.this,AddDeviceActivity.class);
                                ...
                                break;
                            case 1:
                                ECAlertDialog elc = ECAlertDialog.buildAlert(OutDoorWhitleDetailActivity.this,getResources().getString(R.string.delete_or_not), getResources().getString(R.string.cancel), getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                                    @Override
                                ...
                                break;
                            case 2:
                                alertDialog = ECAlertDialog.buildAlert(OutDoorWhitleDetailActivity.this, getResources().getString(R.string.update_name),getResources().getString(R.string.cancel),getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if(!TextUtils.isEmpty(newname)){
                                            ...
                                            try {
                                                ...
                                                if(newname.getBytes(encode).length<=15){
                                                    if(!EmojiFilter.containsEmoji(newname)) {
                                                        ...
                                                        Toast.makeText(OutDoorWhitleDetailActivity.this,getResources().getString(R.string.name_contain_emoji),Toast.LENGTH_SHORT).show();
                                                    }
                                                }else{
                                                    alertDialog.setDismissFalse(false);
                                                    Toast.makeText(OutDoorWhitleDetailActivity.this,getResources().getString(R.string.name_is_too_long),Toast.LENGTH_SHORT).show();
                                                }
                                            ...
                                            alertDialog.setDismissFalse(false);
                                            Toast.makeText(OutDoorWhitleDetailActivity.this,getResources().getString(R.string.name_is_null),Toast.LENGTH_SHORT).show();
                                        }
        ...
        if(TextUtils.isEmpty(device.getEquipmentName())){
            eq_name.setText(getResources().getString(R.string.outdoor_siren)+device.getEqid());
        }else{
        ...
        deviceLogo.setImageResource(R.drawable.detail22);
        ...
        operation.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                sd.sendEquipmentCommand(device.getEqid(),"51000000");
            }
        });
        ...
        volume = (TextView)findViewById(R.id.automodify);
        volume.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SendCommand.Command = SendCommand.EQUIPMENT_CONTROL;
                sd.sendEquipmentCommand(device.getEqid(),"52000000");
            }
        });
    ...
    public  void onEventMainThread(STEvent event){
        if(event.getEvent() == SendCommand.MODIFY_EQUIPMENT_NAME){
            ...
            SendCommand.clearCommnad();
            Toast.makeText(OutDoorWhitleDetailActivity.this,getResources().getString(R.string.delete_success),Toast.LENGTH_SHORT).show();
            ED = new EquipDAO(OutDoorWhitleDetailActivity.this);
            ED.deleteByEqid(device);
            finish();
        }else if(event.getEvent()== SendCommand.EQUIPMENT_CONTROL){
            SendCommand.clearCommnad();
            Toast.makeText(OutDoorWhitleDetailActivity.this,getResources().getString(R.string.success_test),Toast.LENGTH_SHORT).show();
        }
        ...
        HekrUserAction.getInstance(this).getAlarmHistoryList(this, ConnectionPojo.getInstance().deviceTid, ConnectionPojo.getInstance().ctrlKey, ConnectionPojo.getInstance().propubkey, page, new HekrUser.GetDeviceHistoryListener() {
            ...
            public void getFail(int errorCode) {
                ...
                if(errorCode==1){
                    ...
                    Toast.makeText(OutDoorWhitleDetailActivity.this, UnitTools.errorCode2Msg(OutDoorWhitleDetailActivity.this,errorCode),Toast.LENGTH_LONG).show();
                }
            }
        });
    }
