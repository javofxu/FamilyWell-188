 ...
 */
public class CxSmDetailActivity extends AppCompatActivity implements MultiDirectionSlidingDrawer.OnDrawerOpenListener,MultiDirectionSlidingDrawer.OnDrawerCloseListener{
    ...
    private void doStatusShow(String aaaa) {
        ...
        try {
            ...
            }else if("18".equals(draw)){
                root.setBackgroundColor(getResources().getColor(R.color.device_error));
                showStatus.setTextColor(getResources().getColor(R.color.device_error));
                showStatus.setText(getResources().getString(R.string.cxalert8));
    ...
    private void sendSlienceSign(String ds){
        ...
        try {
            int ds2 = Integer.parseInt(device.getEquipmentDesc().substring(device.getEquipmentDesc().length()-2),16);
            if(getResources().getString(R.string.cxalert7).equals(ds)){
                if(isDebugMode()&&ds2>=14){
                    openTestModeAlert();
                }else {
    ...
    private void openSelectSecond(){
        alertDialog2 = ECAlertDialog.buildAlert(CxSmDetailActivity.this, getResources().getString(R.string.please_choose),getResources().getString(R.string.cancel),getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
            }
        }, new DialogInterface.OnClickListener() {
