 ...
 */
public class DoorDetailActivity extends AppCompatActivity implements MultiDirectionSlidingDrawer.OnDrawerOpenListener,MultiDirectionSlidingDrawer.OnDrawerCloseListener{
    private static final String TAG = "DoorDetail";
    private ImageView signal,quatity,deviceLogo;
    private TextView historyInfo,operation,emergencyCall,showStatus,eq_name;
    ...
    private void initViewGuider() {
        ...
        edt_txt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ECListDialog ecListDialog = new ECListDialog(DoorDetailActivity.this,getResources().getStringArray(R.array.DeivceOperation));
                    ...
                    public void onDialogItemClick(Dialog d, int position) {
                        ...
                        switch (position){
                            case 0:
                                ...
                                Intent intent =new Intent(DoorDetailActivity.this,AddDeviceActivity.class);
                                ...
                                break;
                            case 1:
                                ECAlertDialog elc = ECAlertDialog.buildAlert(DoorDetailActivity.this,getResources().getString(R.string.delete_or_not), getResources().getString(R.string.cancel), getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                                    @Override
                                ...
                                break;
                            case 2:
                                alertDialog = ECAlertDialog.buildAlert(DoorDetailActivity.this, getResources().getString(R.string.update_name),getResources().getString(R.string.cancel),getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if(!TextUtils.isEmpty(newname)){
                                            ...
                                            try {
                                                ...
                                                if(newname.getBytes(encode).length<=15){
                                                    if(!EmojiFilter.containsEmoji(newname)) {
                                                        ...
                                                        Toast.makeText(DoorDetailActivity.this,getResources().getString(R.string.name_contain_emoji),Toast.LENGTH_SHORT).show();
                                                    }
                                                }else{
                                                    alertDialog.setDismissFalse(false);
                                                    Toast.makeText(DoorDetailActivity.this,getResources().getString(R.string.name_is_too_long),Toast.LENGTH_SHORT).show();
                                                }
                                            ...
                                            alertDialog.setDismissFalse(false);
                                            Toast.makeText(DoorDetailActivity.this,getResources().getString(R.string.name_is_null),Toast.LENGTH_SHORT).show();
                                        }
        ...
        if(TextUtils.isEmpty(device.getEquipmentName())){
            eq_name.setText(getResources().getString(R.string.door)+device.getEqid());
        }else{
        ...
        deviceLogo.setImageResource(R.drawable.detail10);
        ...
        operation.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                String doAction = operation.getText().toString().trim();
                if("Tset".equals(doAction)){
                    Toast.makeText(DoorDetailActivity.this,doAction,Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(DoorDetailActivity.this,doAction,Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void doStatusShow(String aaaa) {
        try {
            ...
            if("55".equals(draw)){
                ...
                showStatus.setText(getResources().getString(R.string.door_open));
                ...
                root.setBackgroundColor(getResources().getColor(R.color.device_error));
                showStatus.setTextColor(getResources().getColor(R.color.device_error));
                showStatus.setText(getResources().getString(R.string.door_still_open));
            }else {
    ...
    public  void onEventMainThread(STEvent event){
        if(event.getEvent() == SendCommand.MODIFY_EQUIPMENT_NAME){
            ...
            SendCommand.clearCommnad();
            Toast.makeText(DoorDetailActivity.this,getResources().getString(R.string.delete_success),Toast.LENGTH_SHORT).show();
            ED = new EquipDAO(DoorDetailActivity.this);
        ...
        HekrUserAction.getInstance(this).getAlarmHistoryList(this, ConnectionPojo.getInstance().deviceTid, ConnectionPojo.getInstance().ctrlKey, ConnectionPojo.getInstance().propubkey, page, new HekrUser.GetDeviceHistoryListener() {
            ...
            public void getFail(int errorCode) {
                ...
                if(errorCode==1){
                    ...
                    Toast.makeText(DoorDetailActivity.this, UnitTools.errorCode2Msg(DoorDetailActivity.this,errorCode),Toast.LENGTH_LONG).show();
                }
            }
        });
    }
