...
public class ECAlertDialog extends Dialog implements View.OnClickListener {
    ...
    private LinearLayout superTitle;
    private TextView textView_superTitle;
     /**
     * @param context
     */
...
//        getWindow().setAttributes(layoutParams);
        ...
        superTitle = (LinearLayout) findViewById(R.id.dialog_layout_title2);
        textView_superTitle = (TextView) findViewById(R.id.dialog_tv_title2);
        setCancelable(true);
     ...
     * @return
     */
    public static ECAlertDialog buildPositiveAlert(Context ctx , CharSequence message,CharSequence btn , OnClickListener listener) {
        ECAlertDialog dialog = new ECAlertDialog(ctx);
        dialog.setMessage(message);
        dialog.setButton(BUTTON_POSITIVE, btn, listener);
        return dialog;
    }
    ...
    public void setSuperTitle(String text) {
        if(!TextUtils.isEmpty(text)){
            superTitle.setVisibility(View.VISIBLE);
            textView_superTitle.setText(text);
        }
    }
