 ...
 */
public class ECAlertDialog_ipc extends Dialog implements View.OnClickListener {
     ...
     * @param context
     */
    public ECAlertDialog_ipc(Context context) {
        super(context, R.style.Theme_Light_FullScreenDialogAct);
        super.setContentView(R.layout.common_dialog_generic_2);
        initView();
    }
    ...
    public static ECAlertDialog_ipc buildAlert(Context ctx, int message, int button , OnClickListener listener) {
        return buildAlert(ctx, ctx.getString(message) , ctx.getString(button), listener);
    }

    public static ECAlertDialog_ipc buildAlert(Context ctx, int resId, OnClickListener listener) {
        return buildAlert(ctx, resId, R.string.dialog_btn_cancel, R.string.dialog_btn_confim, null, listener);
    }

    public static ECAlertDialog_ipc buildAlert(Context ctx, int resId,
    ...
    public static ECAlertDialog_ipc buildAlert(Context ctx, CharSequence message,
    ...
    public static ECAlertDialog_ipc buildAlert(Context ctx, int message,
    ...
    public static ECAlertDialog_ipc buildAlert(Context ctx, CharSequence message,
                                               ...
                                               OnClickListener negativeClickListener,
                                               OnClickListener positive) {
        ECAlertDialog_ipc dialog = new ECAlertDialog_ipc(ctx);
     ...
     * @return
     */
    public static ECAlertDialog_ipc buildAlert(Context ctx, CharSequence message, CharSequence text,
                                               OnClickListener positive) {
        ECAlertDialog_ipc dialog = new ECAlertDialog_ipc(ctx);
        dialog.setMessage(message);
    ...
    public static ECAlertDialog_ipc buildPositiveAlert(Context ctx , int resId , OnClickListener listener) {
     ...
     * @return
     */
    public static ECAlertDialog_ipc buildPositiveAlert(Context ctx , CharSequence message , OnClickListener listener) {
        ECAlertDialog_ipc dialog = new ECAlertDialog_ipc(ctx);
        dialog.setMessage(message);
    ...
    public final ECAlertDialog_ipc setButtonTag(int id , OnClickListener listener) {
        Button button = mButtons.get(id);
     ...
     * 点击按钮不销毁对话框
     */
    public void setDismissFalse(boolean falg) {
        mDismiss = falg;
    }
