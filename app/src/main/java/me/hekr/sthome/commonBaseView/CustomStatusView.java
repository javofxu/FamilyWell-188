...
public class CustomStatusView extends View {
    ...
    public CustomStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        progressColor = array.getColor(R.styleable.CustomStatusView_progress_color, ContextCompat.getColor(context, R.color.text_color_selected));
        loadSuccessColor = array.getColor(R.styleable.CustomStatusView_load_success_color, ContextCompat.getColor(context, R.color.text_color_selected));
        loadFailureColor = array.getColor(R.styleable.CustomStatusView_load_failure_color, ContextCompat.getColor(context, R.color.num_color));
