package me.hekr.sthome.commonBaseView.loadingView.text;
...
import me.hekr.sthome.commonBaseView.loadingView.ZLoadingBuilder;

/*
@class TextBuilder
@autor henry
@time 2018/12/12 9:46 AM
@email xuejunju_4595@qq.com
*/
public class TextBuilder extends ZLoadingBuilder
{
    private static final int    BASE_ALPHA   = 100;
    private static final String DEFAULT_TEXT = "Zloading";
