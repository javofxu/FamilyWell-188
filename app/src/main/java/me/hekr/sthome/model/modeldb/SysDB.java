...
public class SysDB extends SQLiteOpenHelper {
    ...
    private String dataswitcheqTable = "create table if not exists dataswitcheqTable(eqid varchar(20),deviceid varchar(30),status integer default (0),subeqid integer default (0),reserve varchar(100),reserve2 integer default (0),primary key(subeqid,eqid,deviceid))";
    //  防止重复
    ...
    public SysDB (Context context){
        super(context, CCPAppManager.getUserId()+"_sysdb.db",null,14);
