...
public class PirCheckNewActivity extends TopbarSuperActivity {
    ...
    private void initViewGuider() {
        ...
        getTopBarView().setTopBarStatus(1, 2, name, getResources().getString(R.string.ok), new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mcp.position==-1){
                    Intent i = new Intent(PirCheckNewActivity.this, ModelCellListActivity.class);
                    startActivity(i);
                }else {
                    mcp.position=-1;
                    Intent i = new Intent(PirCheckNewActivity.this, NewGroup2Activity.class);
                    startActivity(i);
                }
                finish();
            }
    ...
    private void initData() {
        ...
        String[] strs = getResources().getStringArray(R.array.pir_signs);
        for(String ds:strs){
            itemslist.add(ds);
        }
