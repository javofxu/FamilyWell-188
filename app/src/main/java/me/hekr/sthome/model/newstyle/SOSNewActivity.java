 ...
 */
public class SOSNewActivity extends TopbarSuperActivity {
            ...
            public void onChanged(WheelView wheel, int oldValue, int newValue) {
                switch (newValue){
                    case 0:
                        ...
                        break;
                    case 1:
                        device.setState("0000AA00");//正常
                        break;
                    case 2:
                        device.setState("0000FF00");//离线
                        break;
                    default:break;
                }
            }
    ...
    private void initViewGuider() {
        ...
        getTopBarView().setTopBarStatus(1, 2, name, getResources().getString(R.string.ok), new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mcp.position==-1){
                    Intent i = new Intent(SOSNewActivity.this, ModelCellListActivity.class);
                    startActivity(i);
                }else {
                    mcp.position=-1;
                    Intent i = new Intent(SOSNewActivity.this, NewGroup2Activity.class);
                    startActivity(i);
                }
                finish();
            }
