...
public class AlarmNewActivity extends TopbarSuperActivity {
            ...
            public void onChanged(WheelView wheel, int oldValue, int newValue) {
                switch (newValue){
                    case 0:
                        ...
                        break;
                    case 1:
                        device.setState("00005500");//设置为正式报警
                        break;
                    case 2:
    ...
    private void initData() {
        ...
        String[] strs = new String[]{getResources().getString(R.string.cxalert7),getResources().getString(R.string.sthalert),getResources().getString(R.string.normal)};
        for(String ds:strs){
            itemslist.add(ds);
        }
        if(mcp.position!=-1){
