 ...
 */
public class DoorCheckNewActivity extends TopbarSuperActivity {
                ...
                public void onChanged(WheelView wheel, int oldValue, int newValue) {
                    switch (newValue){
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            device.setState("00006600");//设置为切换
                            break;
                        default:break;
                    }
                }
    ...
    protected int getLayoutId() {
        return R.layout.activity_new_doorcheck;
    }
    ...
    private void initViewGuider() {
        ...
        getTopBarView().setTopBarStatus(1, 2, name, getResources().getString(R.string.ok), new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mcp.position==-1){
                    Intent i = new Intent(DoorCheckNewActivity.this, ModelCellListActivity.class);
                    startActivity(i);
                }else {
                    mcp.position=-1;
                    Intent i = new Intent(DoorCheckNewActivity.this, NewGroup2Activity.class);
                    startActivity(i);
                }
    ...
    private void initData() {
        String[] strs = getResources().getStringArray(R.array.door_actions);
        for(String ds:strs){
            itemslist.add(ds);
        }
