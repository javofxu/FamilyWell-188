 ...
 */
public class CXSMALARMNewActivity extends TopbarSuperActivity {
    ...
    protected void onCreateInit() {
        ...
        wheelView.addChangingListener(new WheelView.OnWheelChangedListener() {
            ...
            public void onChanged(WheelView wheel, int oldValue, int newValue) {
                switch (newValue){
                    case 0:
                        device.setState("00001900");//设置为烟雾报警
                        break;
                    case 1:
    ...
    private void initData() {
        String[] strs = getResources().getStringArray(R.array.cx_alert_actions);
        for(String ds:strs){
            itemslist.add(ds);
        }
